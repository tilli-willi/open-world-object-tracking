...
python -u main_open_world.py \
    --predict_custom --burst_subdataset "AVA" --burst_subset "val" \
    --detections_path "/home/uig93971/src/Hyp-OW-burst-eval/detections" \
    --burst_annot_path "/home/uig93971/src/data/TAO/burst_annotations" \
    --tao_frames_path "/home/uig93971/src/data/TAO/frames" \
...
PY_ARGS=${@:1}
python -u main_open_world.py \
    --predict_custom --burst_subdataset "HACS" --burst_subset "val" \
    --detections_path "/home/uig93971/src/Hyp-OW-burst-eval/detections" \
    --burst_annot_path "/home/uig93971/src/data/TAO/burst_annotations" \
    --tao_frames_path "/home/uig93971/src/data/TAO/frames" \
    --dataset HIERARCHICAL --PREV_INTRODUCED_CLS 80 --CUR_INTRODUCED_CLS 0 \
