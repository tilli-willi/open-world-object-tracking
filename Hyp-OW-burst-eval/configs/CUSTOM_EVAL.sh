...
EXP_DIR=/home/uig93971/src/Hyp-OW/exps
PY_ARGS=${@:1}
WANDB_NAME=PROB_V1
 
PY_ARGS=${@:1}
python -u main_open_world.py \
    --output_dir "exps/eval_BURST_val_t4_ft_hierarchical_split_20per_img" --dataset HIERARCHICAL --PREV_INTRODUCED_CLS 80 --CUR_INTRODUCED_CLS 0 \
    ...
    --save_eval_det_file "/home/uig93971/src/Hyp-OW-burst-eval/detections/burst_val_high_t4_20per_img/detections.json" --all_background --empty_weight 0.1 --use_max_uperbound  --family_regularizer --family_hyperbolic_coeff 0.02  \
    ${PY_ARGS}
