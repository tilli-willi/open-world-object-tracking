...
def main(args):
    ...
    if args.distributed:
        ...
        if dataset_train: sampler_train = torch.utils.data.RandomSampler(dataset_train)
        sampler_val = torch.utils.data.SequentialSampler(dataset_val)

    if dataset_train: batch_sampler_train = torch.utils.data.BatchSampler(sampler_train, args.batch_size, drop_last=True)
    if dataset_train: data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,
